...
public class MultipleAdapterViewApplication<T extends ik> extends FrameLayout implements AndroidApplicationBase {
    ...
    public MultipleAdapterViewApplication(Context context) {
        this(context, null);
    }

    public MultipleAdapterViewApplication(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public MultipleAdapterViewApplication(Context context, AttributeSet attributeSet, int i) {
    ...
    public AndroidViewApplication.Callbacks getCallbacks() {
        return this.callbacks;
    }

    public void setCallbacks(AndroidViewApplication.Callbacks callbacks) {
    ...
    public View initializeForView(T t, AndroidApplicationConfiguration androidApplicationConfiguration) {
        ...
        this.graphics = new AndroidGraphicsEx(this, androidApplicationConfiguration, androidApplicationConfiguration.resolutionStrategy == null ? new FillResolutionStrategy() : androidApplicationConfiguration.resolutionStrategy);
        ...
        addLifecycleListener(new iu() { // from class: com.badlogic.gdx.backends.android.MultipleAdapterViewApplication.1
            @Override // defpackage.iu
            public void resume() {
                MultipleAdapterViewApplication.this.audio.resume();
            }

            @Override // defpackage.iu
            public void pause() {
                MultipleAdapterViewApplication.this.audio.pause();
            }

            @Override // defpackage.iu
            public void dispose() {
                MultipleAdapterViewApplication.this.audio.dispose();
            }
        });
        abz.a().a = this;
        abz.a().d = m5getInput();
    ...
    public void postRunnable(Runnable runnable) {
        synchronized (this.runnables) {
            ...
            abz.a().b.requestRendering();
        }
    }

    public void exit() {
        log(TAG, "exit");
        this.handler.post(new Runnable() { // from class: com.badlogic.gdx.backends.android.MultipleAdapterViewApplication.2
            @Override // java.lang.Runnable
            public void run() {
                MultipleAdapterViewApplication.this.callbacks.exit();
            }
        });
    }
    ...
    public void onResume() {
        ...
        abz.a().f = getNet();
        this.input.onResume();
        AndroidGraphicsEx androidGraphicsEx = this.graphics;
        if (androidGraphicsEx != null) {
            androidGraphicsEx.onResumeGLSurfaceView();
        }
        if (!this.firstResume) {
            this.audio.resume();
