    ...
    public static final class ZipEntryRO {
        ...
        public void setOffsetFromFile(RandomAccessFile randomAccessFile, ByteBuffer byteBuffer) throws IOException {
            ...
            try {
                ...
                this.mOffset = j + 30 + (byteBuffer.getShort(26) & ZipResourceFile.kMaxCommentLen) + (byteBuffer.getShort(28) & ZipResourceFile.kMaxCommentLen);
        ...
        if (read4LE == kEOCDSignature) {
            ...
            if (j3 + j2 > length) {
                ...
                while (i2 < s) {
                    ...
                    zipEntryRO.mMethod = map.getShort(i3 + 10) & s2;
