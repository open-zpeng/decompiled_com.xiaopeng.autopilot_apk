...
public class InteractiveMsgService implements IInteractiveMsgService {
        ...
        if (ipcMessageEvent != null && ipcMessageEvent.getMsgID() == 11012 && "com.xiaopeng.aiassistant".equals(ipcMessageEvent.getSenderPackageName())) {
            ...
            if (from.getMsgId() == 3) {
                try {
                    ...
                    c.a().d(new IInteractiveMsgService.SpeakEndEvent(asJsonObject.get(Constants.ID).getAsString(), asJsonObject.get(Constants.END_STATE).getAsInt()));
                } catch (Exception e) {
                    Log.e(TAG, "onEvent", e);
                }
            } else if (from.getMsgId() >= 100) {
                c.a().d(new IInteractiveMsgService.InteractiveMsgEvent(from));
            }
        }
    }
    ...
    public void sendMessage(int i, String str) {
        ...
        ThreadUtils.postBackground(new Runnable() { // from class: com.xiaopeng.lib.framework.aiassistantmodule.InteractiveMsgService.1
    ...
    public void speak(String str, String str2) {
        ...
        jsonObject.addProperty(Constants.TEXT, str);
        jsonObject.addProperty(Constants.ID, str2);
    ...
    public void shutup(String str) {
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty(Constants.ID, str);
