...
public class CarControllerModuleEntry implements IModuleEntry {
    ...
    private void connectCarWhenInit() {
        ...
        synchronized (this) {
            if (!this.mIsInited) {
                this.mHandlerThread = new HandlerThread("CarControllerModule");
                this.mHandlerThread.start();
                this.mCarApiClient = Car.createCar(this.mContext, new ServiceConnection() { // from class: com.xiaopeng.lib.framework.carcontrollermodule.CarControllerModuleEntry.1
