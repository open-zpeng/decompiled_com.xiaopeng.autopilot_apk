...
public class SystemPropertyUtil {
    ...
    public static void setFaceRecognition(boolean z) {
        SystemProperties.set(SYSTEM_PROPERTY_FACE_RECOGNITION, String.valueOf(z));
    }
    ...
    public static void setAiosWakeUpEnable(boolean z) {
        SystemProperties.set(SYSTEM_PROPERTY_AIOS_WAKEUP, z ? BuildInfoUtils.BID_WAN : "0");
    }
    ...
    public static void setInCall(boolean z) {
        SystemProperties.set(SYSTEM_PROPERTY_CALLING, z ? BuildInfoUtils.BID_WAN : "0");
    }
