    ...
    private static void setViewResource(Context context, View view, String str, int i) {
        ...
        try {
            if (ThemeManager.AttributeSet.ALPHA.equals(str)) {
                ...
                view.setBackground(getOverlayDrawable(ed.a(applicationContext, i), view.getBackground()));
            } else if (ThemeManager.AttributeSet.FOREGROUND.equals(str)) {
                if (Build.VERSION.SDK_INT >= 23) {
                    view.setForeground(getOverlayDrawable(ed.a(applicationContext, i), view.getForeground()));
                }
            } else if (ThemeManager.AttributeSet.SCROLLBAR_THUMB_VERTICAL.equals(str)) {
                setVerticalThumbDrawable(view, ed.a(applicationContext, i));
            } else if (ThemeManager.AttributeSet.SRC.equals(str)) {
                if (view instanceof ImageView) {
                    ImageView imageView = (ImageView) view;
                    imageView.setImageDrawable(getOverlayDrawable(ed.a(applicationContext, i), imageView.getDrawable()));
                }
            } else if (ThemeManager.AttributeSet.TEXT_COLOR.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    ((android.widget.TextView) view).setTextColor(ed.b(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.TEXT_COLOR_HINT.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    ((android.widget.TextView) view).setHintTextColor(ed.b(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DRAWABLE_LEFT.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    setCompoundDrawables(0, (android.widget.TextView) view, ed.a(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DRAWABLE_TOP.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    setCompoundDrawables(1, (android.widget.TextView) view, ed.a(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DRAWABLE_RIGHT.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    setCompoundDrawables(2, (android.widget.TextView) view, ed.a(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DRAWABLE_BOTTOM.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    setCompoundDrawables(3, (android.widget.TextView) view, ed.a(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DRAWABLE_START.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    setCompoundDrawables(4, (android.widget.TextView) view, ed.a(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DRAWABLE_END.equals(str)) {
                if (view instanceof android.widget.TextView) {
                    setCompoundDrawables(5, (android.widget.TextView) view, ed.a(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.PROGRESS_DRAWABLE.equals(str)) {
                if (view instanceof ProgressBar) {
                    ((ProgressBar) view).setProgressDrawable(ed.a(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.THUMB.equals(str)) {
                if (view instanceof SeekBar) {
                    ((SeekBar) view).setThumb(ed.a(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.BUTTON.equals(str)) {
                if (view instanceof CompoundButton) {
                    ((CompoundButton) view).setButtonDrawable(ed.a(applicationContext, i));
                }
            } else if (ThemeManager.AttributeSet.DIVIDER.equals(str) && (view instanceof ListView)) {
                ((ListView) view).setDivider(ed.a(applicationContext, i));
            }
