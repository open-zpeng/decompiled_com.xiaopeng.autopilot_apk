...
public class Xui {
    ...
    public static void init(Application application) {
        ...
        if (BuildInfoUtils.BID_WAN.equals(getSystemProperties("persist.sys.xp.shared_display.enable"))) {
            sSharedDisplay = true;
        }
        mPackageName = application.getPackageName();
        Log.i("xpui", sSharedDisplay + ",0.9.9_HEAD_227f2f2_2023/05/06 07:26:59");
    }
