...
public class XDatePickerDialog extends XDialog implements XDialogInterface.OnClickListener, XDatePicker.OnDateChangedListener {
    ...
    public XDatePickerDialog(Context context) {
        this(context, acu.k.XDialogView_Large, null, Calendar.getInstance(), -1, -1, -1);
    }
    ...
    public XDatePickerDialog(Context context, OnXDateSetListener onXDateSetListener, int i, int i2, int i3) {
        this(context, acu.k.XDialogView_Large, onXDateSetListener, null, i, i2, i3);
    }
    ...
    private XDatePickerDialog(Context context, int i, OnXDateSetListener onXDateSetListener, Calendar calendar, int i2, int i3, int i4) {
        ...
        View inflate = LayoutInflater.from(context).inflate(acu.i.x_date_picker, getContentView(), false);
        ...
        this.mDatePicker = (XDatePicker) inflate.findViewById(acu.g.x_date_picker);
    ...
    private static int resolveDialogTheme(Context context, int i) {
        return i == 0 ? acu.k.XDialogView_Large : i;
    }
