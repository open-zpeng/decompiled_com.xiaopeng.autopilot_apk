...
public class XLoadingDialog extends Dialog implements Runnable {
    ...
    public static XLoadingDialog show(Context context, boolean z, DialogInterface.OnCancelListener onCancelListener) {
        return show(context, context.getString(acu.j.x_loading_dialog_message), z, onCancelListener);
    }
    ...
    public static XLoadingDialog show(Context context, boolean z, int i, OnTimeOutListener onTimeOutListener) {
        return show(context, context.getString(acu.j.x_loading_dialog_message), z, i, onTimeOutListener);
    }
    ...
    public static XLoadingDialog show(Context context, CharSequence charSequence, boolean z, DialogInterface.OnCancelListener onCancelListener, boolean z2, int i, OnTimeOutListener onTimeOutListener) {
        XLoadingDialog xLoadingDialog = new XLoadingDialog(context, acu.k.XAppTheme_XDialog_Loading);
    ...
    protected void onCreate(Bundle bundle) {
        View inflate = LayoutInflater.from(getContext()).inflate(acu.i.x_loading_dialog, (ViewGroup) null);
        this.mMessageView = (TextView) inflate.findViewById(acu.g.x_loading_dialog_text);
        this.mCloseView = (ImageButton) inflate.findViewById(acu.g.x_loading_dialog_close);
    ...
    public void setVerticalTopDefault() {
        setVertical(48, (int) getContext().getResources().getDimension(acu.e.x_loading_dialog_top));
    }
