...
public class XPanelActivity extends d {
    ...
    public void onPostCreate(Bundle bundle) {
        ...
        int dp2px = dp2px(this, acu.e.x_compat_app_panel_x);
        int dp2px2 = dp2px(this, acu.e.x_compat_app_panel_y);
        int dp2px3 = dp2px(this, acu.e.x_compat_app_panel_width);
        int dp2px4 = dp2px(this, acu.e.x_compat_app_panel_height);
        switch (i) {
            case 1:
