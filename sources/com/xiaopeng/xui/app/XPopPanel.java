...
public class XPopPanel implements IVuiViewScene {
    ...
    public static class XPopPanelBuilder {
        ...
        private int mType = 1;
        private int mBg = acu.f.x_osd_background;
    ...
    public static class TN extends IOsdListener.Stub {
        ...
        public TN(Context context, int i, int i2, int i3, String str, int i4, int i5, boolean z, View view, boolean z2, boolean z3) {
            ...
            this.mParams.windowAnimations = acu.k.XAnimation_XOsd;
        ...
        private void setBackgroundLayout(View view, int i, int i2, int i3, int i4) {
            int i5 = this.mAutoHeight ? 0 : i3;
            if (this.mBackgroundLayout == null) {
                this.mBackgroundLayout = new BackgroundLayout(this.mContext, this.mBg, this.mClickable, i2, i5, i4, this.listener);
                this.mBackgroundLayout.setClipToOutline(true);
                this.mBackgroundLayout.setTN(this);
                this.mBackgroundLayout.setBackground(ea.a(this.mContext, this.mBg));
    ...
    public static class BackgroundLayout extends XLinearLayout {
        ...
        protected void onMeasure(int i, int i2) {
            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.mSetWidth, 1073741824);
    ...
    public void initVuiScene(String str, abo aboVar, abp abpVar) {
        if (this.mPopPanelView != null) {
            ...
            this.mPopPanelView.initVuiScene(str, aboVar, abpVar);
        }
    }
}
