...
public class XActivityDelegateImpl extends XActivityDelegate implements XActivityDismissCause.CallBack, XActivityDismissExtend.OnDismissListenerEx {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public XActivityDelegateImpl(d dVar) {
        this.mActivity = dVar;
        init();
    }
    ...
    private int analysisAnnotation(Class<?> cls) {
        ...
        if (superclass == null || superclass.getName().equals(d.class.getName())) {
            return 0;
        }
    ...
    public void onPostCreate(Bundle bundle) {
        ...
        this.mHandler.post(new Runnable() { // from class: com.xiaopeng.xui.app.delegate.-$$Lambda$XActivityDelegateImpl$6XVAO5Gie534uR4q1YRdDVP8vl8
            ...
            public final void run() {
                XActivityDelegateImpl.lambda$onPostCreate$0(XActivityDelegateImpl.this);
            }
        });
    }

    public static /* synthetic */ void lambda$onPostCreate$0(XActivityDelegateImpl xActivityDelegateImpl) {
        XLogUtils.d(TAG, "activityTemplate: " + xActivityDelegateImpl.mActivityTemplate.toString());
        XLogUtils.d(TAG, "dismiss: " + xActivityDelegateImpl.mActivityDismiss.toString());
        XLogUtils.d(TAG, "windowVisible: " + xActivityDelegateImpl.mWindowVisible.toString());
        XLogUtils.d(TAG, "dismissCause: " + xActivityDelegateImpl.mActivityDismissCauseGroup.toString());
    }
    ...
    public View createView(View view, String str, Context context, AttributeSet attributeSet) {
        return this.mActivity.getDelegate().a(view, str, context, attributeSet);
    }
