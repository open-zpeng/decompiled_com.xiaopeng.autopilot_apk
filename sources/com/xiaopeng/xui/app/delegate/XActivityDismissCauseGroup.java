...
public abstract class XActivityDismissCauseGroup implements XActivityDismissCause.BackCause, XActivityDismissCause.OnPauseCause, XActivityDismissCause.OutSideCause, XActivityDismissCause.SpeedTimeCause, XActivityLifecycle {
    /* JADX INFO: Access modifiers changed from: package-private */
    ...
    private static class XActivityDismissCauseGroupImpl extends XActivityDismissCauseGroup {
        ...
        public String toString() {
            ...
            sb.append(this.mSpeedTimeOutSceneInspect != null ? "has" : "no");
            sb.append('}');
            return sb.toString();
        }
    }
