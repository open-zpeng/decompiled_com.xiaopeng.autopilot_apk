...
public abstract class XActivityTemplateExtend implements XActivityLifecycle, XActivityTemplate {
    ...
    /* loaded from: classes.dex */
    public static class BaseTemplate extends XActivityTemplateExtend {
        Activity mActivity;
        ...
        public void useXDialogView(XDialogView xDialogView) {
            ...
            xDialogView.setOnDismissListener(new XDialogViewInterface.OnDismissListener() { // from class: com.xiaopeng.xui.app.delegate.-$$Lambda$XActivityTemplateExtend$DialogImpl$DiJCLdF0nAV_RQv_es325X0eRGw
                ...
                public final void onDismiss(XDialogView xDialogView2) {
                    XActivityTemplateExtend.DialogImpl.lambda$useXDialogView$0(XActivityTemplateExtend.DialogImpl.this, xDialogView2);
                }
            });
        }

        public static /* synthetic */ void lambda$useXDialogView$0(DialogImpl dialogImpl, XDialogView xDialogView) {
            XLogUtils.i(XActivityTemplateExtend.TAG, "onDismiss for dialog ");
            if (dialogImpl.mDismiss != null) {
                dialogImpl.mDismiss.dismiss(0);
            }
        }
    }
    ...
    private static class PanelImpl extends BaseTemplate implements XActivityTemplate.Panel {
        ...
        void initWindowAttributes(XActivityWindowAttributes xActivityWindowAttributes) {
            ...
            int dip2px = XuiUtils.dip2px(this.mActivity, acu.e.x_compat_app_panel_x);
            int dip2px2 = XuiUtils.dip2px(this.mActivity, acu.e.x_compat_app_panel_y);
            int dip2px3 = XuiUtils.dip2px(this.mActivity, acu.e.x_compat_app_panel_width);
            int dip2px4 = XuiUtils.dip2px(this.mActivity, acu.e.x_compat_app_panel_height);
            switch (i) {
                case 1:
