...
public final class XIndicatorDrawable extends Drawable {
    ...
    public static /* synthetic */ void lambda$new$0(XIndicatorDrawable xIndicatorDrawable, ValueAnimator valueAnimator) {
        ...
        xIndicatorDrawable.mIndicatorStart = xIndicatorDrawable.mAnimIndicatorStart - (xIndicatorDrawable.mIndicatorStartDistance * (1.0f - f));
        float f2 = floatValue * xIndicatorDrawable.mIndicatorEndAnimSpeed;
        if (f2 > 1.0f) {
            f2 = 1.0f;
        }
        xIndicatorDrawable.mIndicatorEnd = xIndicatorDrawable.mAnimIndicatorEnd - (xIndicatorDrawable.mIndicatorEndDistance * (1.0f - f2));
    ...
    public void inflateAttrs(Resources resources, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (theme != null) {
            obtainAttributes = theme.obtainStyledAttributes(attributeSet, acu.l.XSegmented, 0, 0);
        } else {
            obtainAttributes = resources.obtainAttributes(attributeSet, acu.l.XSegmented);
        }
        this.mIndicatorColorRes = obtainAttributes.getResourceId(acu.l.XSegmented_segment_indicator_color, acu.d.x_segment_indicator_color);
        this.mIndicatorType = obtainAttributes.getInt(acu.l.XSegmented_segment_indicator_type, 0);
        onConfigurationChanged(resources, theme);
        if (this.mIndicatorType == 1) {
            this.mIndicatorPercent = obtainAttributes.getFloat(acu.l.XSegmented_segment_line_width_percent, 1.0f);
            this.mIndicatorHeight = dp(resources, 4);
            this.mIndicatorPaddingBottom = obtainAttributes.getDimension(acu.l.XSegmented_segment_line_padding_bottom, dp(resources, 6));
    ...
    public void onConfigurationChanged(Resources resources, Resources.Theme theme) {
        ...
        this.mDefaultColor = resources.getColor(acu.d.x_segment_indicator_color, theme);
        setPaintColor();
