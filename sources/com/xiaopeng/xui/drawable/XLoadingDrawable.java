...
public class XLoadingDrawable extends Drawable {
    ...
    private int mColorId = acu.d.x_theme_text_01;
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        TypedArray obtainAttributes = resources.obtainAttributes(attributeSet, acu.l.XLoadingDrawable);
        this.mColorId = obtainAttributes.getResourceId(acu.l.XLoadingDrawable_loading_color, acu.d.x_theme_text_01);
        this.mColor = resources.getColor(this.mColorId, theme);
        setType(obtainAttributes.getInt(acu.l.XLoadingDrawable_loading_type, 3));
    ...
    public static /* synthetic */ void lambda$makeAnimations$0(XLoadingDrawable xLoadingDrawable, int i, int i2, ValueAnimator valueAnimator) {
        ...
        float[] fArr = xLoadingDrawable.mRectHeights;
        float f = xLoadingDrawable.minHeight;
        fArr[i] = f + ((xLoadingDrawable.maxHeight - f) * floatValue);
        int i3 = i2 - 1;
        xLoadingDrawable.mRectTopYs[i] = (xLoadingDrawable.mCenterY - (fArr[i] * 0.5f)) + (((i3 * 0.5f) - i) * ((float) Math.tan(DEFAULT_RADIANS)) * (xLoadingDrawable.mSpacingX + xLoadingDrawable.mRectWidth));
        if (i == i3) {
