...
public class XRadioDrawable extends Drawable {
    ...
    private void inflateAttrs(Resources resources, Resources.Theme theme) {
        ...
        if (resources != null) {
            this.mBgEnableNormalColor = resources.getColor(acu.d.x_theme_primary_neutral_normal, theme);
            this.mBgEnablePressedColor = resources.getColor(acu.d.x_theme_primary_neutral_pressed, theme);
            this.mBgDisableColor = resources.getColor(acu.d.x_theme_primary_neutral_disable, theme);
            this.mCircleEnableColor = resources.getColor(acu.d.x_theme_primary_normal, theme);
            this.mCircleDisableColor = resources.getColor(acu.d.x_radio_disable_color, theme);
            this.mInnerEnableColor = resources.getColor(acu.d.x_radio_inner_color, theme);
            this.mInnerDisableColor = resources.getColor(acu.d.x_radio_inner_disable_color, theme);
