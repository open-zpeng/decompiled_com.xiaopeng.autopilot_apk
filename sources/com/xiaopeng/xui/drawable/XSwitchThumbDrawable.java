...
public class XSwitchThumbDrawable extends Drawable {
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        if (theme != null) {
            obtainAttributes = theme.obtainStyledAttributes(attributeSet, acu.l.XSwitchThumbDrawable, 0, 0);
        } else {
            obtainAttributes = resources.obtainAttributes(attributeSet, acu.l.XSwitchThumbDrawable);
        }
        this.mWidth = obtainAttributes.getDimensionPixelSize(acu.l.XSwitchThumbDrawable_switch_thumb_width, 44);
        this.mHeight = obtainAttributes.getDimensionPixelSize(acu.l.XSwitchThumbDrawable_switch_thumb_height, 44);
        this.mPadding = obtainAttributes.getDimension(acu.l.XSwitchThumbDrawable_switch_thumb_padding, 4.0f);
        this.mThumbRoundRadius = obtainAttributes.getDimensionPixelSize(acu.l.XSwitchThumbDrawable_switch_thumb_round_radius, 7);
        this.mIndicatorRoundRadius = obtainAttributes.getDimensionPixelSize(acu.l.XSwitchThumbDrawable_switch_thumb_indicator_round_radius, 3);
        float dimension = obtainAttributes.getDimension(acu.l.XSwitchThumbDrawable_switch_thumb_indicator_width, 6.0f);
        float dimension2 = obtainAttributes.getDimension(acu.l.XSwitchThumbDrawable_switch_thumb_indicator_height, 18.0f);
        ...
        this.mIndicatorColors = obtainAttributes.getColorStateList(acu.l.XSwitchThumbDrawable_switch_thumb_indicator_color);
        ...
        this.mThumbColors = obtainAttributes.getColorStateList(acu.l.XSwitchThumbDrawable_switch_thumb_color);
    ...
    private void initAnimator() {
        ...
        this.mIndicatorAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.xiaopeng.xui.drawable.-$$Lambda$XSwitchThumbDrawable$_8TGbMiDSEHt9T8cU-EIc9is2Zs
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                XSwitchThumbDrawable.lambda$initAnimator$0(XSwitchThumbDrawable.this, f, valueAnimator);
            }
        });
    ...
    public static /* synthetic */ void lambda$initAnimator$0(XSwitchThumbDrawable xSwitchThumbDrawable, float f, ValueAnimator valueAnimator) {
        int intValue = ((Integer) valueAnimator.getAnimatedValue()).intValue();
        if (xSwitchThumbDrawable.mChecked) {
            xSwitchThumbDrawable.mIndicatorTopOffset = f - Math.round((intValue / 100.0f) * f);
        } else {
            xSwitchThumbDrawable.mIndicatorTopOffset = Math.round(f * (intValue / 100.0f));
        }
        xSwitchThumbDrawable.invalidateSelf();
    }
