...
public class XCheckBoxDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        this.mPaint.setColor(this.mColorBg.getColorForState(getState(), acu.d.x_check_box_inner_color));
        ...
        if (StateSet.stateSetMatches(CHECKED_STATE_SET, getState())) {
            this.mPaint.setStyle(Paint.Style.FILL);
            this.mPaint.setColor(this.mColorFront.getColorForState(getState(), acu.d.x_check_box_frame_color));
            ...
            this.mPaint.setColor(this.mColorInner.getColorForState(getState(), acu.d.x_radio_inner_color_selector));
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        this.mColorBg = resources.getColorStateList(acu.d.x_check_box_inner_color, theme);
        this.mColorFront = resources.getColorStateList(acu.d.x_check_box_frame_color, theme);
        this.mColorInner = resources.getColorStateList(acu.d.x_radio_inner_color_selector, theme);
