...
public class XCircularProgressBgDrawable extends Drawable {
    ...
    private void updateAttr(Resources resources, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (theme != null) {
            obtainAttributes = theme.obtainStyledAttributes(attributeSet, acu.l.XCircularProgressBgDrawable, 0, 0);
        } else {
            obtainAttributes = resources.obtainAttributes(attributeSet, acu.l.XCircularProgressBgDrawable);
        }
        this.mProgressBgColor = obtainAttributes.getColor(acu.l.XCircularProgressBgDrawable_progress_backgroundColor, resources.getColor(acu.d.x_circular_progress_circle_bg_color, theme));
        this.mPaint.setColor(this.mProgressBgColor);
        this.mStrokeWidth = obtainAttributes.getDimension(acu.l.XCircularProgressBgDrawable_progress_background_strokeWidth, 0.0f);
        this.mInset = obtainAttributes.getDimensionPixelSize(acu.l.XCircularProgressBgDrawable_progress_background_inset, 0);
        this.mIndicatorPlay = obtainAttributes.getDrawable(acu.l.XCircularProgressBgDrawable_progress_bg_indicator_play);
        this.mIndicatorPause = obtainAttributes.getDrawable(acu.l.XCircularProgressBgDrawable_progress_bg_indicator_pause);
        this.mIndicatorStop = obtainAttributes.getDrawable(acu.l.XCircularProgressBgDrawable_progress_bg_indicator_stop);
        this.mIndicatorStart = obtainAttributes.getDrawable(acu.l.XCircularProgressBgDrawable_progress_bg_indicator_start);
    ...
    protected boolean onStateChange(int[] iArr) {
        ...
        while (true) {
            ...
            int i2 = iArr[i];
            if (i2 == acu.c.progress_state_playing_stop) {
                z2 = false;
                z3 = false;
                z = true;
                break;
            } else if (i2 == acu.c.progress_state_playing_pause) {
                z = false;
                z3 = false;
                z2 = true;
                break;
            } else if (i2 == acu.c.progress_state_paused) {
                z = false;
                z2 = false;
                z3 = true;
                break;
            } else {
                if (i2 == acu.c.progress_state_start_download) {
                    z6 = true;
                }
                i++;
            }
