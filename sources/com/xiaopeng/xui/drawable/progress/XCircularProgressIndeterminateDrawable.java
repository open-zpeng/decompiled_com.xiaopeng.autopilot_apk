...
public class XCircularProgressIndeterminateDrawable extends Drawable {
    ...
    private void updateAttr(Resources resources, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (theme != null) {
            obtainAttributes = theme.obtainStyledAttributes(attributeSet, acu.l.XCircularProgressIndeterminateDrawable, 0, 0);
        } else {
            obtainAttributes = resources.obtainAttributes(attributeSet, acu.l.XCircularProgressIndeterminateDrawable);
        }
        this.mStartColor = obtainAttributes.getColor(acu.l.XCircularProgressIndeterminateDrawable_progress_indeterminate_startColor, resources.getColor(17170445, theme));
        this.mEndColor = obtainAttributes.getColor(acu.l.XCircularProgressIndeterminateDrawable_progress_indeterminate_endColor, resources.getColor(acu.d.x_circular_progress_primary_color, theme));
        this.mStrokeWidth = obtainAttributes.getDimension(acu.l.XCircularProgressIndeterminateDrawable_progress_indeterminate_strokeWidth, 0.0f);
        this.mEnableLight = obtainAttributes.getBoolean(acu.l.XCircularProgressIndeterminateDrawable_progress_indeterminate_enable_light, false);
        this.mInset = obtainAttributes.getDimensionPixelSize(acu.l.XCircularProgressIndeterminateDrawable_progress_indeterminate_inset, 0);
        this.mLightRadius = obtainAttributes.getDimensionPixelOffset(acu.l.XCircularProgressIndeterminateDrawable_progress_indeterminate_light_radius, 0);
