...
public class XCircularProgressPgDrawable extends Drawable {
    ...
    private void updateAttr(Resources resources, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (theme != null) {
            obtainAttributes = theme.obtainStyledAttributes(attributeSet, acu.l.XCircularProgressPgDrawable, 0, 0);
        } else {
            obtainAttributes = resources.obtainAttributes(attributeSet, acu.l.XCircularProgressPgDrawable);
        }
        this.mProgressColor = obtainAttributes.getColor(acu.l.XCircularProgressPgDrawable_progress_color, resources.getColor(acu.d.x_circular_progress_primary_color, theme));
        this.mStrokeWidth = obtainAttributes.getDimension(acu.l.XCircularProgressPgDrawable_progress_pg_strokeWidth, 0.0f);
        this.mEnableLight = obtainAttributes.getBoolean(acu.l.XCircularProgressPgDrawable_progress_enable_light, false);
        this.mInset = obtainAttributes.getDimensionPixelSize(acu.l.XCircularProgressPgDrawable_progress_pg_inset, 0);
        this.mLightRadius = obtainAttributes.getDimensionPixelOffset(acu.l.XCircularProgressPgDrawable_progress_pg_light_radius, 0);
