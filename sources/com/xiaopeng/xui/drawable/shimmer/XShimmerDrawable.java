...
public class XShimmerDrawable extends Drawable {
    ...
    public XShimmer parseShimmer(Resources resources, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (theme != null) {
            obtainAttributes = theme.obtainStyledAttributes(attributeSet, acu.l.XShimmerDrawable, 0, 0);
        } else {
            obtainAttributes = resources.obtainAttributes(attributeSet, acu.l.XShimmerDrawable);
        }
        try {
            XShimmer.Builder colorHighlightBuilder = (obtainAttributes.hasValue(acu.l.XShimmerDrawable_shimmer_colored) && obtainAttributes.getBoolean(acu.l.XShimmerDrawable_shimmer_colored, false)) ? new XShimmer.ColorHighlightBuilder() : new XShimmer.AlphaHighlightBuilder();
