...
public class XBackgroundPaddingUtils {
    public static Rect backgroundPadding(View view, AttributeSet attributeSet) {
        ...
        int i3;
        int i4;
        TypedArray obtainStyledAttributes = view.getContext().obtainStyledAttributes(attributeSet, acu.l.XBackgroundPadding);
        if (obtainStyledAttributes.getBoolean(acu.l.XBackgroundPadding_x_bg_padding_enable, false)) {
            if (obtainStyledAttributes.hasValue(acu.l.XBackgroundPadding_x_bg_padding)) {
                i = obtainStyledAttributes.getDimensionPixelSize(acu.l.XBackgroundPadding_x_bg_padding, -1);
                i2 = i;
                i3 = i2;
                i4 = i3;
            } else {
            ...
            if (obtainStyledAttributes.hasValue(acu.l.XBackgroundPadding_x_bg_padding_left)) {
                i2 = obtainStyledAttributes.getDimensionPixelSize(acu.l.XBackgroundPadding_x_bg_padding_left, -1);
            }
            if (obtainStyledAttributes.hasValue(acu.l.XBackgroundPadding_x_bg_padding_right)) {
                i3 = obtainStyledAttributes.getDimensionPixelSize(acu.l.XBackgroundPadding_x_bg_padding_right, -1);
            }
            if (obtainStyledAttributes.hasValue(acu.l.XBackgroundPadding_x_bg_padding_top)) {
                i4 = obtainStyledAttributes.getDimensionPixelSize(acu.l.XBackgroundPadding_x_bg_padding_top, -1);
            }
            if (obtainStyledAttributes.hasValue(acu.l.XBackgroundPadding_x_bg_padding_bottom)) {
                i = obtainStyledAttributes.getDimensionPixelSize(acu.l.XBackgroundPadding_x_bg_padding_bottom, -1);
            }
