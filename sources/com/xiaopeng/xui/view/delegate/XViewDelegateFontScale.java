...
public class XViewDelegateFontScale extends XViewDelegatePart {
    ...
    public static XViewDelegateFontScale create(TextView textView, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = textView.getContext().obtainStyledAttributes(attributeSet, acu.l.XFontSize, i, i2);
        boolean z2 = obtainStyledAttributes.getBoolean(acu.l.XFontSize_x_dynamic_font_scale_change_enable, true);
