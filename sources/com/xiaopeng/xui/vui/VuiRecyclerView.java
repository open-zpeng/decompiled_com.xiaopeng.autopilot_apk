...
public class VuiRecyclerView extends j implements abn, VuiView {
    ...
    private final j.c mAdapterDataObserver;
    ...
    public VuiRecyclerView(Context context) {
        ...
        this.mAdapterDataObserver = new j.c() { // from class: com.xiaopeng.xui.vui.VuiRecyclerView.2
    ...
    public void initVuiAttr(String str, abo aboVar) {
        this.mSceneId = str;
        this.mVuiEngine = aboVar;
    }

    public void initVuiAttr(String str, abo aboVar, boolean z) {
        this.mSceneId = str;
        this.mVuiEngine = aboVar;
        this.mIsItemChanged = z;
    }

    public void initVuiAttr(String str, abo aboVar, boolean z, boolean z2) {
        this.mSceneId = str;
    ...
    public void initVuiAttr(String str, abo aboVar, boolean z, boolean z2, boolean z3) {
        this.mSceneId = str;
        this.mIsNeedScroll = z;
        this.mIsNeedLayout = z2;
        this.mVuiEngine = aboVar;
        ...
        if (this.mIsVuiCanControlScroll) {
            ...
            try {
                ...
                if (this.mIsEnableInvisible && (layoutManager = getLayoutManager()) != null && (layoutManager instanceof LinearLayoutManager)) {
                    ...
                    vuiProps.put("displayStart", this.mIsReverse ? i2 - linearLayoutManager.q() : this.mStartPosition + linearLayoutManager.o());
                    vuiProps.put("displayEnd", this.mIsReverse ? i2 - linearLayoutManager.o() : this.mStartPosition + linearLayoutManager.q());
                ...
                if (getVuiAction().equals(abq.SCROLLBYY.getName())) {
