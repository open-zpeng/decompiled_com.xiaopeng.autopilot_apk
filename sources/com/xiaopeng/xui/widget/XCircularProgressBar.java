...
public class XCircularProgressBar extends ProgressBar {
    ...
    private static final int[] STATE_PLAYING_STOP = {acu.c.progress_state_playing_stop};
    private static final int[] STATE_PLAYING_PAUSE = {acu.c.progress_state_playing_pause};
    private static final int[] STATE_PAUSED = {acu.c.progress_state_paused};
    private static final int[] STATE_START_DOWNLOAD = {acu.c.progress_state_start_download};
    ...
    public XCircularProgressBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, acu.k.XProgressBar_Circular_Medium);
    }

    public XCircularProgressBar(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, acu.k.XProgressBar_Circular_Medium);
    }
    ...
    private void init(AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, acu.l.XCircularProgressBar, i, i2);
        this.mEnableIndicator = obtainStyledAttributes.getBoolean(acu.l.XCircularProgressBar_progress_enableIndicator, false);
        this.mIndicatorType = obtainStyledAttributes.getInt(acu.l.XCircularProgressBar_progress_indicatorType, 0);
        this.mInset = obtainStyledAttributes.getDimensionPixelSize(acu.l.XCircularProgressBar_progress_inset, 0);
        this.mStrokeWidth = obtainStyledAttributes.getDimensionPixelOffset(acu.l.XCircularProgressBar_progress_strokeWidth, 0);
        boolean z = obtainStyledAttributes.getBoolean(acu.l.XCircularProgressBar_android_enabled, true);
        this.mLightRadius = obtainStyledAttributes.getDimensionPixelOffset(acu.l.XCircularProgressBar_progress_light_radius, 0);
        this.mIndicatorPlay = obtainStyledAttributes.getDrawable(acu.l.XCircularProgressBar_progress_indicator_play);
        this.mIndicatorPause = obtainStyledAttributes.getDrawable(acu.l.XCircularProgressBar_progress_indicator_pause);
        this.mIndicatorStop = obtainStyledAttributes.getDrawable(acu.l.XCircularProgressBar_progress_indicator_stop);
        this.mIndicatorStart = obtainStyledAttributes.getDrawable(acu.l.XCircularProgressBar_progress_indicator_start);
        this.mIndicatorPlayId = obtainStyledAttributes.getResourceId(acu.l.XCircularProgressBar_progress_indicator_play, 0);
        this.mIndicatorPauseId = obtainStyledAttributes.getResourceId(acu.l.XCircularProgressBar_progress_indicator_pause, 0);
        this.mIndicatorStopId = obtainStyledAttributes.getResourceId(acu.l.XCircularProgressBar_progress_indicator_stop, 0);
        this.mIndicatorStartId = obtainStyledAttributes.getResourceId(acu.l.XCircularProgressBar_progress_indicator_start, 0);
        this.mIndeterminateDrId = obtainStyledAttributes.getResourceId(acu.l.XCircularProgressBar_android_indeterminateDrawable, 0);
        this.mProgressDrawableId = obtainStyledAttributes.getResourceId(acu.l.XCircularProgressBar_android_progressDrawable, 0);
