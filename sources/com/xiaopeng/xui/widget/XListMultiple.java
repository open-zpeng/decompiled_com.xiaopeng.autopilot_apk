...
public class XListMultiple extends XRelativeLayout {
    ...
    public XListMultiple(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        int i3;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, acu.l.XListMultiple);
        switch (obtainStyledAttributes.getInt(acu.l.XListMultiple_list_multiple_type, 0)) {
            case 1:
                i3 = acu.i.x_list_multiple_two;
                break;
            case 2:
                i3 = acu.i.x_list_multiple_wrap;
                break;
            default:
                i3 = acu.i.x_list_multiple;
                break;
        }
        LayoutInflater.from(context).inflate(i3, this);
        initView();
        this.mTextSub.setMaxLines(obtainStyledAttributes.getInt(acu.l.XListMultiple_list_text_sub_lines, 1));
        setText(obtainStyledAttributes.getString(acu.l.XListMultiple_list_multiple_text));
        setTextSub(obtainStyledAttributes.getString(acu.l.XListMultiple_list_multiple_text_sub));
        int resourceId = obtainStyledAttributes.getResourceId(acu.l.XListMultiple_list_multiple_bottom, -1);
        if (resourceId != -1) {
            this.mBottomViewStub.setLayoutResource(resourceId);
            this.mBottomViewStub.inflate();
        }
        int resourceId2 = obtainStyledAttributes.getResourceId(acu.l.XListMultiple_list_multiple_right, -1);
        if (resourceId2 != -1) {
    ...
    private void initView() {
        ...
        this.mBottomViewStub = (ViewStub) findViewById(acu.g.x_list_bottom);
