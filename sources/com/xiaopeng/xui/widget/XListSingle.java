...
public class XListSingle extends XRelativeLayout {
    ...
    public XListSingle(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        LayoutInflater.from(context).inflate(acu.i.x_list_single, this);
        initView();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, acu.l.XListSingle);
        setText(obtainStyledAttributes.getString(acu.l.XListSingle_list_single_text));
        int resourceId = obtainStyledAttributes.getResourceId(acu.l.XListSingle_list_single_left, -1);
        if (resourceId != -1) {
        ...
        int resourceId2 = obtainStyledAttributes.getResourceId(acu.l.XListSingle_list_single_right, -1);
        if (resourceId2 != -1) {
        ...
        int resourceId3 = obtainStyledAttributes.getResourceId(acu.l.XListSingle_list_single_tag_icon, -1);
        if (resourceId3 != -1) {
            setTagIcon(resourceId3);
        }
        boolean z = obtainStyledAttributes.getBoolean(acu.l.XListSingle_list_single_tag, false);
        showIconTag(z);
        this.mLeftRightTouchFull = obtainStyledAttributes.getInt(acu.l.XListSingle_list_single_left_right_touch_full, 0);
        obtainStyledAttributes.recycle();
        if (resourceId2 != -1) {
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.mText.getLayoutParams();
            marginLayoutParams.setMarginEnd((int) getResources().getDimension(z ? acu.e.x_list_tv_has_tag_margin_end : acu.e.x_list_tv_margin_end));
            ...
            marginLayoutParams2.setMarginEnd((int) getResources().getDimension(acu.e.x_list_tv_has_tag_margin_end));
