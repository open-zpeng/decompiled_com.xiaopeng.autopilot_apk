...
public class XListTwo extends XRelativeLayout {
    ...
    public XListTwo(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        LayoutInflater.from(context).inflate(acu.i.x_list_two, this);
        initView();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, acu.l.XListTwo);
        setText(obtainStyledAttributes.getString(acu.l.XListTwo_list_two_text));
        setTextSub(obtainStyledAttributes.getString(acu.l.XListTwo_list_two_text_sub));
        this.mTextSub.setMaxLines(obtainStyledAttributes.getInt(acu.l.XListTwo_list_text_sub_lines, 1));
        int resourceId = obtainStyledAttributes.getResourceId(acu.l.XListTwo_list_two_left, -1);
        if (resourceId != -1) {
        ...
        int resourceId2 = obtainStyledAttributes.getResourceId(acu.l.XListTwo_list_two_right, -1);
        if (resourceId2 != -1) {
        ...
        int resourceId3 = obtainStyledAttributes.getResourceId(acu.l.XListTwo_list_two_tag_icon, -1);
        if (resourceId3 != -1) {
            setTagIcon(resourceId3);
        }
        showIconTag(obtainStyledAttributes.getBoolean(acu.l.XListTwo_list_two_tag, false));
        int resourceId4 = obtainStyledAttributes.getResourceId(acu.l.XListTwo_list_two_tag_custom, -1);
        if (resourceId4 != -1) {
            this.mTagCustomViewStub.setLayoutResource(resourceId4);
            this.mTagCustomViewStub.inflate();
        }
        this.mLeftRightTouchFull = obtainStyledAttributes.getInt(acu.l.XListTwo_list_two_left_right_touch_full, 0);
        obtainStyledAttributes.recycle();
        if (resourceId2 != -1) {
            View findViewById = findViewById(acu.g.x_list_tv_lay);
            int dimension = (int) getResources().getDimension(acu.e.x_list_tv_margin_end);
    ...
    private void initView() {
        this.mText = (TextView) findViewById(acu.g.x_list_tv);
        this.mNum = (TextView) findViewById(acu.g.x_list_num);
        this.mLeftView = (ViewGroup) findViewById(acu.g.x_list_left_lay);
        this.mTvLay = (ViewGroup) findViewById(acu.g.x_list_tv_lay);
        this.mTextSub = (TextView) findViewById(acu.g.x_list_tv_sub);
        this.mLeftViewStub = (ViewStub) findViewById(acu.g.x_list_left);
        this.mRightViewStub = (ViewStub) findViewById(acu.g.x_list_right);
        this.mTag = (ImageView) findViewById(acu.g.x_list_tag);
        this.mTagCustomViewStub = (ViewStub) findViewById(acu.g.x_list_tag_custom_lay);
        if (isInEditMode()) {
            return;
        }
        this.mNum.setTextAppearance(acu.k.XFont_Number_Bold);
    }
    ...
    public void showNum(boolean z) {
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(acu.e.x_list_left_width_for_num);
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(acu.e.x_list_left_width);
