...
public class XLoading extends XView {
    ...
    public XLoading(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, acu.k.XLoading_XLarge);
    }

    public XLoading(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, acu.k.XLoading_XLarge);
    }
    ...
    private void init(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, acu.l.XLoading, i, i2);
        this.mDrawable.setType(obtainStyledAttributes.getInt(acu.l.XLoading_loading_type, 3));
