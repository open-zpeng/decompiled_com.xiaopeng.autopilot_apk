...
public class XNumberPicker extends XLinearLayout {
    ...
    public XNumberPicker(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, acu.k.XNumberPicker);
    }

    public XNumberPicker(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, acu.k.XNumberPicker);
    }
    ...
    public XNumberPicker(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mInitialScrollOffset = j.UNDEFINED_DURATION;
        this.mScrollState = 0;
        this.mLastHandledDownDpadKeyCode = -1;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, acu.l.XNumberPicker, i, i2);
        this.mHideWheelUntilFocused = obtainStyledAttributes.getBoolean(acu.l.XNumberPicker_np_hideWheelUntilFocused, false);
        this.mTextLayout = obtainStyledAttributes.getInt(acu.l.XNumberPicker_np_textLayout, 1);
        this.mSolidColor = obtainStyledAttributes.getColor(acu.l.XNumberPicker_np_solidColor, 0);
        Drawable drawable = obtainStyledAttributes.getDrawable(acu.l.XNumberPicker_np_selectionDivider);
        if (drawable != null) {
        ...
        this.mSymbol = obtainStyledAttributes.getDrawable(acu.l.XNumberPicker_np_symbol);
        this.mSelectionDividerHeight = obtainStyledAttributes.getDimensionPixelSize(acu.l.XNumberPicker_np_selectionDividerHeight, (int) TypedValue.applyDimension(1, 2.0f, getResources().getDisplayMetrics()));
        this.mSelectionDividersDistance = obtainStyledAttributes.getDimensionPixelSize(acu.l.XNumberPicker_np_selectionDividersDistance, (int) TypedValue.applyDimension(1, 48.0f, getResources().getDisplayMetrics()));
        this.mTextLayoutMargin = obtainStyledAttributes.getDimensionPixelSize(acu.l.XNumberPicker_np_text_layout_margin, 0);
        this.mMinHeight = obtainStyledAttributes.getDimensionPixelSize(acu.l.XNumberPicker_np_internalMinHeight, -1);
        this.mMaxHeight = obtainStyledAttributes.getDimensionPixelSize(acu.l.XNumberPicker_np_internalMaxHeight, -1);
        int i5 = this.mMinHeight;
        if (i5 != -1 && (i4 = this.mMaxHeight) != -1 && i5 > i4) {
            throw new IllegalArgumentException("minHeight > maxHeight");
        }
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(acu.l.XNumberPicker_np_internalMinWidth, -1);
        this.mMaxWidth = obtainStyledAttributes.getDimensionPixelSize(acu.l.XNumberPicker_np_internalMaxWidth, -1);
        int i6 = this.mMinWidth;
        if (i6 != -1 && (i3 = this.mMaxWidth) != -1 && i6 > i3) {
            throw new IllegalArgumentException("minWidth > maxWidth");
        }
        this.mComputeMaxWidth = this.mMaxWidth == -1;
        this.mTextSize = obtainStyledAttributes.getDimensionPixelSize(acu.l.XNumberPicker_android_textSize, 20);
        this.mSelectedTextSize = obtainStyledAttributes.getDimensionPixelSize(acu.l.XNumberPicker_np_selectedTextSize, 20);
        this.mTextColors = obtainStyledAttributes.getColorStateList(acu.l.XNumberPicker_android_textColor);
        ...
        paint.setTypeface(Typeface.create(getResources().getString(acu.j.x_font_typeface_medium), 0));
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        if (ThemeManager.isThemeChanged(configuration)) {
            this.mTextColors = getContext().getResources().getColorStateList(acu.d.x_number_picker_text_color, null);
            postInvalidate();
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i2 = 0; i2 < iArr.length; i2++) {
            ...
            if (z) {
                if (i2 == 2) {
                    this.mSelectorWheelPaint.setColor(this.mTextColors.getColorForState(SELECTED_STATE_SET, -16777216));
                    this.mSelectorWheelPaint.setTextSize(this.mSelectedTextSize);
                    int i3 = this.mTextLayout;
                    if (i3 == 0) {
                        f2 = this.mTextLayoutMargin;
                    } else if (i3 == 2) {
                        f2 = (getRight() - getLeft()) - this.mTextLayoutMargin;
                    } else {
                    ...
                    if (i4 == 0) {
                        f = this.mTextLayoutMargin;
                    } else if (i4 == 2) {
                        f = (getRight() - getLeft()) - this.mTextLayoutMargin;
                    } else {
        ...
        int i6 = this.mSelectionDividerHeight + i5;
        drawable.setBounds(0, i5, this.mWidth, i6);
        this.mSelectionDivider.draw(canvas);
        int i7 = this.mBottomSelectionDividerBottom;
        int i8 = i7 - this.mSelectionDividerHeight;
        this.mSelectionDivider.setBounds(0, i8, this.mWidth, i7);
        this.mSelectionDivider.draw(canvas);
        Drawable drawable2 = this.mSymbol;
        if (drawable2 != null) {
            int i9 = ((i6 * 2) + i8) / 3;
            int i10 = (i6 + (i8 * 2)) / 3;
            int i11 = this.mTextLayout;
            if (i11 != 0) {
                if (i11 != 2) {
                    return;
                }
                drawable2.setBounds(35, i9, 41, i9 + 6);
                this.mSymbol.draw(canvas);
                this.mSymbol.setBounds(35, i10 - 6, 41, i10);
                this.mSymbol.draw(canvas);
                return;
            }
            int i12 = this.mWidth;
            drawable2.setBounds(i12 - 6, i9, i12, i9 + 6);
            this.mSymbol.draw(canvas);
            Drawable drawable3 = this.mSymbol;
            int i13 = this.mWidth;
            drawable3.setBounds(i13 - 6, i10 - 6, i13, i10);
            this.mSymbol.draw(canvas);
        }
    }
    ...
    /* loaded from: classes.dex */
    public static class CustomEditText extends l {
