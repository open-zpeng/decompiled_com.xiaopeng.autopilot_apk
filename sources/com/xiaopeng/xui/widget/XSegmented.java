...
public class XSegmented extends XLinearLayout implements abn, View.OnClickListener {
    ...
    public XSegmented(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, acu.l.XSegmented, i, i2);
        CharSequence[] textArray = obtainStyledAttributes.getTextArray(acu.l.XSegmented_segment_vui_labels);
        int i3 = obtainStyledAttributes.getInt(acu.l.XSegmented_segment_selected_pos, -1);
        if (obtainStyledAttributes.getBoolean(acu.l.XSegmented_segment_anim_disable_click, false)) {
        ...
        if (obtainStyledAttributes.hasValue(acu.l.XSegmented_segment_texts)) {
            this.mTextSize = obtainStyledAttributes.getDimension(acu.l.XSegmented_segment_text_size, acu.e.x_font_title_03_size);
            this.mTextColorRes = obtainStyledAttributes.getResourceId(acu.l.XSegmented_segment_text_color, acu.d.x_tabs_layout_title_color);
            addSegmentView(obtainStyledAttributes.getTextArray(acu.l.XSegmented_segment_texts), textArray);
        } else {
            TypedArray obtainTypedArray = getResources().obtainTypedArray(obtainStyledAttributes.getResourceId(acu.l.XSegmented_segment_icons, 0));
    ...
    public void addSegmentView(CharSequence charSequence, CharSequence charSequence2, int i) {
        if (charSequence != null) {
            ...
            xTextView.setVuiElementType(abr.TEXTVIEW);
