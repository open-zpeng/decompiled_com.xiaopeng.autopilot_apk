...
public class XSwitch extends XCompoundButton implements ValueAnimator.AnimatorUpdateListener {
    ...
    public XSwitch(Context context, AttributeSet attributeSet) {
        ...
        this.PADDING_TOP = getResources().getDimension(acu.e.x_switch_padding_top);
        this.PADDING_LEFT = getResources().getDimension(acu.e.x_switch_padding_start);
    ...
    private void init() {
        ...
        setButtonDrawable(acu.f.x_switch_drawable);
    ...
    private void initColor() {
        ...
        this.mBgEnableOffNormalColorStart = getColor(acu.d.x_switch_bg_off_enable_normal_start_color);
        this.mBgEnableOffNormalColorEnd = getColor(acu.d.x_switch_bg_off_enable_normal_end_color);
        this.mBgEnableOffPressedColorStart = getColor(acu.d.x_switch_bg_off_enable_pressed_start_color);
        this.mBgEnableOffPressedColorEnd = getColor(acu.d.x_switch_bg_off_enable_pressed_end_color);
        this.mBgEnableOnNormalColorStart = getColor(acu.d.x_switch_bg_on_enable_normal_start_color);
        this.mBgEnableOnNormalColorEnd = getColor(acu.d.x_switch_bg_on_enable_normal_end_color);
        this.mBgEnableOnPressedColorStart = getColor(acu.d.x_switch_bg_on_enable_pressed_start_color);
        this.mBgEnableOnPressedColorEnd = getColor(acu.d.x_switch_bg_on_enable_pressed_end_color);
        this.mBgDisableOffColorStart = getColor(acu.d.x_switch_bg_off_disable_start_color);
        this.mBgDisableOffColorEnd = getColor(acu.d.x_switch_bg_off_disable_end_color);
        this.mBgDisableOnColorStart = getColor(acu.d.x_switch_bg_on_disable_start_color);
        this.mBgDisableOnColorEnd = getColor(acu.d.x_switch_bg_on_disable_end_color);
        this.mCircleOutEnableOffColorStart = getColor(acu.d.x_switch_circle_out_off_enable_start_color);
        this.mCircleOutEnableOffColorEnd = getColor(acu.d.x_switch_circle_out_off_enable_end_color);
        this.mCircleOutEnableOnColorStart = getColor(acu.d.x_switch_circle_out_on_enable_start_color);
        this.mCircleOutEnableOnColorEnd = getColor(acu.d.x_switch_circle_out_on_enable_end_color);
        this.mCircleOutDisableOffColorStart = getColor(acu.d.x_switch_circle_out_off_disable_start_color);
        this.mCircleOutDisableOffColorEnd = getColor(acu.d.x_switch_circle_out_off_disable_end_color);
        this.mCircleOutDisableOnColorStart = getColor(acu.d.x_switch_circle_out_on_disable_start_color);
        this.mCircleOutDisableOnColorEnd = getColor(acu.d.x_switch_circle_out_on_disable_end_color);
        this.mCircleOutShadowColor = getColor(acu.d.x_switch_circle_out_shadow_color);
        this.mCircleInnerEnableColorStart = getColor(acu.d.x_switch_circle_inner_enable_start_color);
        this.mCircleInnerEnableColorEnd = getColor(acu.d.x_switch_circle_inner_enable_end_color);
        this.mCircleInnerDisableColorStart = getColor(acu.d.x_switch_circle_inner_disable_start_color);
        this.mCircleInnerDisableColorEnd = getColor(acu.d.x_switch_circle_inner_disable_end_color);
        this.mVerticalEnableOffColor = getColor(acu.d.x_switch_vertical_off_enable_color);
        this.mVerticalEnableOnColor = getColor(acu.d.x_switch_vertical_on_enable_color);
        this.mVerticalDisableOffColor = getColor(acu.d.x_switch_vertical_off_disable_color);
        this.mVerticalDisableOnColor = getColor(acu.d.x_switch_vertical_on_disable_color);
        changeParams();
    }
    ...
    private void changeParams() {
        ...
        if (isEnabled()) {
            ...
            int i3 = this.mCircleInnerEnableColorStart;
            int i4 = this.mCircleInnerEnableColorEnd;
            ...
            int i5 = this.mCircleInnerDisableColorStart;
            int i6 = this.mCircleInnerDisableColorEnd;
