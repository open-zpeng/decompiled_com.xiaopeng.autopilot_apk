...
public class XTabLayout extends XLinearLayout implements abn {
    ...
    public XTabLayout(Context context, AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i, i2 == 0 ? acu.k.XTabLayoutAppearance : i2);
        this.MARGIN_DAY = 0;
        ...
        getContext().getTheme();
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, acu.l.XTabLayout, i == 0 ? acu.k.XTabLayoutAppearance : i, acu.k.XTabLayoutAppearance);
        this.mTitleString = obtainStyledAttributes.getTextArray(acu.l.XTabLayout_titles);
        this.mTitleTextSize = obtainStyledAttributes.getDimension(acu.l.XTabLayout_titleTextSize, 35.0f);
        final XFontScaleHelper create = XFontScaleHelper.create(obtainStyledAttributes, acu.l.XTabLayout_titleTextSize);
        if (create != null && this.mXViewDelegate != null) {
            this.mXViewDelegate.setFontScaleChangeCallback(new XViewDelegate.onFontScaleChangeCallback() { // from class: com.xiaopeng.xui.widget.-$$Lambda$XTabLayout$Z8VnPCfc0CTRF4FLt1FkISn004c
                @Override // com.xiaopeng.xui.view.XViewDelegate.onFontScaleChangeCallback
                public final void onFontScaleChanged() {
                    XTabLayout.lambda$new$0(XTabLayout.this, create);
                }
            });
        }
        this.mTitleTextColorStateList = obtainStyledAttributes.getColorStateList(acu.l.XTabLayout_titleTextColorStateList);
        int integer = obtainStyledAttributes.getInteger(acu.l.XTabLayout_selectTab, 0);
        this.mIndicatorWidth = obtainStyledAttributes.getDimension(acu.l.XTabLayout_indicatorWidth, 0.0f);
        this.mIndicatorWidthPercent = obtainStyledAttributes.getFraction(acu.l.XTabLayout_indicatorWidthPercent, 1, 1, 0.7f);
        this.mIndicatorMaxHeight = obtainStyledAttributes.getDimension(acu.l.XTabLayout_indicatorMaxHeight, dp(4));
        this.mIndicatorMinHeight = obtainStyledAttributes.getDimension(acu.l.XTabLayout_indicatorMinHeight, dp(2));
        this.mIndicatorHeight = this.mIndicatorMaxHeight;
        this.mIndicatorMarginBottom = obtainStyledAttributes.getDimension(acu.l.XTabLayout_indicatorMarginBottom, dp(6));
        this.mIndicatorColor = obtainStyledAttributes.getResourceId(acu.l.XTabLayout_indicatorColor, acu.d.x_theme_primary_normal);
        this.mIndicatorColorFrom = obtainStyledAttributes.getColor(acu.l.XTabLayout_indicatorColorFrom, -1);
        this.mIndicatorColorTo = obtainStyledAttributes.getColor(acu.l.XTabLayout_indicatorColorTo, -1);
        this.mIndicatorShadowColor = obtainStyledAttributes.getColor(acu.l.XTabLayout_indicatorShadowColor, -15880455);
        this.mIndicatorShadowRadius = obtainStyledAttributes.getDimension(acu.l.XTabLayout_indicatorShadowRadius, dp(4));
        this.mIndicatorColor2 = obtainStyledAttributes.getResourceId(acu.l.XTabLayout_indicatorColor2, acu.d.x_table_indicator_color);
        this.mIndicatorShadowColor2 = obtainStyledAttributes.getColor(acu.l.XTabLayout_indicatorShadowColor2, -15880455);
        this.mIndicatorShadowRadius2 = obtainStyledAttributes.getDimension(acu.l.XTabLayout_indicatorShadowRadius2, dp(4));
        this.mIndicatorAnimatorEnable = obtainStyledAttributes.getBoolean(acu.l.XTabLayout_indicatorAnimatorEnable, true);
        this.mTitleTextColorRes = obtainStyledAttributes.getResourceId(acu.l.XTabLayout_titleTextColorStateList, -1);
        this.mTabsBarStyle = obtainStyledAttributes.getBoolean(acu.l.XTabLayout_tabsBarStyle, false);
        this.mTabCustomBackground = obtainStyledAttributes.getBoolean(acu.l.XTabLayout_tabCustomBackground, false);
        this.mPaddingNight = obtainStyledAttributes.getDimensionPixelSize(acu.l.XTabLayout_tabPaddingNight, dp(40));
        this.mIndicatorDayNightDiff = obtainStyledAttributes.getBoolean(acu.l.XTabLayout_indicatorDayNightDiff, false);
        int resourceId = obtainStyledAttributes.getResourceId(acu.l.XTabLayout_tabLayoutIcons, 0);
        if (resourceId != 0) {
        ...
        this.mIconVuiLabels = obtainStyledAttributes.getTextArray(acu.l.XTabLayout_tabLayoutVuiLabels);
        setGravity(17);
    ...
    public static /* synthetic */ void lambda$new$0(XTabLayout xTabLayout, XFontScaleHelper xFontScaleHelper) {
        for (int i = 0; i < xTabLayout.getChildCount(); i++) {
            View childAt = xTabLayout.getChildAt(i);
    ...
    public int addTab(CharSequence charSequence, int i) {
        TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(acu.i.x_tab_layout_title_view, (ViewGroup) this, false);
    ...
    public int addTab(int i, int i2, String str) {
        ...
        xImageView.setVuiElementType(abr.TEXTVIEW);
    ...
    public boolean onVuiElementEvent(final View view, aby abyVar) {
        ...
        if (view == null || (d = (Double) abyVar.a(abyVar)) == null) {
            return false;
        }
        post(new Runnable() { // from class: com.xiaopeng.xui.widget.-$$Lambda$XTabLayout$o0b378XW3dLRaQ5gH_g-yosLqkI
            @Override // java.lang.Runnable
            public final void run() {
                XTabLayout.lambda$onVuiElementEvent$1(XTabLayout.this, d, view);
            }
        });
        return true;
    }

    public static /* synthetic */ void lambda$onVuiElementEvent$1(XTabLayout xTabLayout, Double d, View view) {
        if (d.intValue() < xTabLayout.getChildCount()) {
            VuiFloatingLayerManager.show(xTabLayout.getChildAt(d.intValue()));
        } else {
            VuiFloatingLayerManager.show(view);
        }
        xTabLayout.setPerformVuiAction(true);
        xTabLayout.selectTab(d.intValue(), true, true);
        xTabLayout.setPerformVuiAction(false);
    }
}
