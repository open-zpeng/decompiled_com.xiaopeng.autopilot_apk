...
public class XTabsBar extends XRelativeLayout implements abn {
    ...
    private void initView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (i == 0) {
            i = acu.k.XTabsBarAppearance_Left;
        }
        TypedArray obtainStyledAttributes = theme.obtainStyledAttributes(attributeSet, acu.l.XTabsBar, i, i);
        float dimension = obtainStyledAttributes.getDimension(acu.l.XTabsBar_tabsBarMarginStart, dp(24));
        float dimension2 = obtainStyledAttributes.getDimension(acu.l.XTabsBar_tabsBarTabGap, 0.0f);
        float dimension3 = obtainStyledAttributes.getDimension(acu.l.XTabsBar_tabsBarTabWidth, dp(ThemeManager.UI_MODE_THEME_MASK));
        float dimension4 = obtainStyledAttributes.getDimension(acu.l.XTabsBar_tabsBarTabHeight, dp(130));
        int integer = obtainStyledAttributes.getInteger(acu.l.XTabsBar_tabsBarBtnVisibility, 0);
        int integer2 = obtainStyledAttributes.getInteger(acu.l.XTabsBar_tabsBarTitleVisibility, 8);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(context).inflate(acu.i.x_tabsbar, this);
        this.mIconBtn = (XImageButton) findViewById(acu.g.x_tabsbar_btn_close);
        ...
        this.mIconBtnLay = (ViewGroup) findViewById(acu.g.x_x_tabsbar_btn_close_lay);
        ((XTextView) findViewById(acu.g.x_tabsbar_tv_title)).setVisibility(integer2);
    ...
    public abx onBuildVuiElement(String str, abl ablVar) {
        try {
            this.mTabLayout.setVuiElementType(abr.XTABLAYOUT);
            this.mTabLayout.setVuiMode(abt.NORMAL);
            if (this.mIconBtn.getVisibility() != 0) {
                this.mIconBtn.setVuiMode(abt.DISABLED);
            } else {
