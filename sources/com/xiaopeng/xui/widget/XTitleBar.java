...
public class XTitleBar extends XLinearLayout implements abn, View.OnClickListener {
    ...
    public boolean onVuiElementEvent(View view, aby abyVar) {
        return false;
    }
    ...
    public XTitleBar(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        LayoutInflater.from(context).inflate(acu.i.x_titlebar, this);
        initView();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, acu.l.XTitleBar);
        setBackVisibility(obtainStyledAttributes.getInt(acu.l.XTitleBar_title_back, 8));
        setCloseVisibility(obtainStyledAttributes.getInt(acu.l.XTitleBar_title_close, 0));
        setTitle(obtainStyledAttributes.getString(acu.l.XTitleBar_title_text));
        switch (obtainStyledAttributes.getInt(acu.l.XTitleBar_title_action_mode, 0)) {
            case 0:
                this.mRightContainer.setVisibility(8);
                break;
            case 1:
                int resourceId = obtainStyledAttributes.getResourceId(acu.l.XTitleBar_title_action_1, -1);
                int resourceId2 = obtainStyledAttributes.getResourceId(acu.l.XTitleBar_title_action_2, -1);
                if (resourceId != -1) {
                ...
                break;
            case 2:
                String string = obtainStyledAttributes.getString(acu.l.XTitleBar_title_action_1);
                if (string != null) {
                ...
                break;
            case 4:
                int resourceId3 = obtainStyledAttributes.getResourceId(acu.l.XTitleBar_title_action_1, -1);
                if (resourceId3 != -1) {
    ...
    private void initView() {
        this.mBtnClose = (XImageButton) findViewById(acu.g.x_titlebar_btn_close);
        this.mBtnBack = (XImageButton) findViewById(acu.g.x_titlebar_btn_back);
        this.mTitle = (TextView) findViewById(acu.g.x_titlebar_tv_title);
        this.mRightContainer = (ViewGroup) findViewById(acu.g.x_titlebar_right_container);
        this.mBtnCloseLay = (ViewGroup) findViewById(acu.g.x_titlebar_btn_close_lay);
    ...
    private void addActionWithIcon(int... iArr) {
        if (iArr != null) {
            for (int i = 0; i < iArr.length; i++) {
                ImageButton imageButton = (ImageButton) LayoutInflater.from(getContext()).inflate(acu.i.x_titlebar_action_icon, this.mRightContainer, false);
    ...
    private void addActionWithButton(CharSequence... charSequenceArr) {
        for (int i = 0; i < charSequenceArr.length; i++) {
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(acu.i.x_titlebar_action_ghostbtn, this.mRightContainer, false);
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == acu.g.x_titlebar_btn_close) {
        ...
        } else if (id == acu.g.x_titlebar_btn_back) {
        ...
        try {
            if (this.mBtnBack != null) {
                if (this.mBtnBack.getVisibility() != 0) {
                    this.mBtnBack.setVuiMode(abt.DISABLED);
                } else {
            ...
            if (this.mBtnClose != null) {
                if (this.mBtnClose.getVisibility() != 0) {
                    this.mBtnClose.setVuiMode(abt.DISABLED);
                    return null;
                }
