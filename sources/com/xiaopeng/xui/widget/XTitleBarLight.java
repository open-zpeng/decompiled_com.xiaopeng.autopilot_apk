...
public class XTitleBarLight extends XRelativeLayout implements abn, View.OnClickListener {
    ...
    public XTitleBarLight(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        LayoutInflater.from(context).inflate(acu.i.x_titlebarlight, this);
        initView();
        this.mSparsePadding = (int) getResources().getDimension(acu.e.x_title_bar_light_sparse_padding);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, acu.l.XTitleBarLight);
        setTitle(obtainStyledAttributes.getString(acu.l.XTitleBarLight_title_text));
        setMainAction(obtainStyledAttributes.getInt(acu.l.XTitleBarLight_title_main_action, 0));
        setTitleType(obtainStyledAttributes.getInt(acu.l.XTitleBarLight_title_text_type, 0));
        int resourceId = obtainStyledAttributes.getResourceId(acu.l.XTitleBarLight_title_right_action_layout, 0);
        if (resourceId > 0) {
    ...
    public void onClick(View view) {
        ...
        } else if (id != acu.g.x_titlebar_btn_back || (onTitleBarClickListener = this.mOnTitleBarClickListener) == null) {
        } else {
