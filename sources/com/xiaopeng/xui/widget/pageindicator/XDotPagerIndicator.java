...
public class XDotPagerIndicator extends XViewPagerIndicatorAbs {
    ...
    public void init() {
        super.init();
        this.mDotSize = getContext().getResources().getDimensionPixelSize(acu.e.x_pager_indicator_view_size);
        int dimensionPixelOffset = getContext().getResources().getDimensionPixelOffset(acu.e.x_pager_indicator_dot_padding);
    ...
    protected View generateIndicator() {
        ...
        xImageView.setImageResource(acu.f.x_dot_indicator_bg);
        ...
        if (ThemeManager.isThemeChanged(configuration)) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt instanceof ImageView) {
                    ((ImageView) childAt).setImageResource(acu.f.x_dot_indicator_bg);
                }
            }
        }
    }
