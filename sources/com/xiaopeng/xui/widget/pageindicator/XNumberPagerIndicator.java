...
public class XNumberPagerIndicator extends XViewPagerIndicatorAbs {
    ...
    public void init() {
        super.init();
        int dimensionPixelOffset = getContext().getResources().getDimensionPixelOffset(acu.e.x_pager_indicator_number_padding);
        setPadding(dimensionPixelOffset, 0, dimensionPixelOffset, 0);
        this.mChildViewSize = getContext().getResources().getDimensionPixelSize(acu.e.x_pager_indicator_view_size);
        this.mFormat = getContext().getString(acu.j.x_number_indicator_desc_format);
    }
    ...
    public void populateData(int i) {
        if (this.mTextView == null) {
            ...
            this.mTextView.setTextAppearance(acu.k.XNumberIndicatorSelectedTextStyle);
    ...
    private void refreshText() {
        if (this.mTextView != null) {
            ...
            TextAppearanceSpan textAppearanceSpan = new TextAppearanceSpan(getContext(), acu.k.XNumberIndicatorTextStyle);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        if (ThemeManager.isThemeChanged(configuration)) {
            ...
            if (textView != null) {
                textView.setTextAppearance(acu.k.XNumberIndicatorSelectedTextStyle);
            }
            refreshText();
        }
    }
