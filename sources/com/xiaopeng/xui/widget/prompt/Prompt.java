...
public abstract class Prompt {
    ...
    public Prompt(Context context) {
        ...
        this.mShortTime = context.getResources().getInteger(acu.h.x_prompt_shortTime);
        this.mLongTime = context.getResources().getInteger(acu.h.x_prompt_longTime);
        initAnim();
    }

    private void initAnim() {
        this.mIsUseExitAnim = true;
        this.mEnterAnim = AnimationUtils.loadAnimation(this.mContext, acu.a.x_prompt_enter_anim);
        this.mExitAnim = AnimationUtils.loadAnimation(this.mContext, acu.a.x_prompt_exit_anim);
        ...
        this.mChangeAnim = AnimationUtils.loadAnimation(this.mContext, acu.a.x_prompt_change_anim);
    }
