...
public class XPromptView extends XFrameLayout implements View.OnClickListener {
    ...
    public XPromptView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(acu.i.x_prompt, this);
        this.mContentView = (ViewGroup) findViewById(acu.g.x_prompt_layout);
        this.mTextView = (TextView) findViewById(acu.g.x_prompt_text);
        this.mActionView = (ImageButton) findViewById(acu.g.x_prompt_btn);
        this.mActionView2 = (Button) findViewById(acu.g.x_prompt_btn_2);
        findViewById(acu.g.x_prompt_btn).setOnClickListener(this);
        findViewById(acu.g.x_prompt_btn_2).setOnClickListener(this);
        setId(acu.g.x_prompt);
        int dimension = (int) getResources().getDimension(acu.e.x_prompt_padding_left);
    ...
    public void onClick(View view) {
        Prompt prompt;
        if (view.getId() == acu.g.x_prompt_btn) {
            Prompt prompt2 = this.mPrompt;
            if (prompt2 != null) {
                prompt2.onAction(0);
            }
        } else if (view.getId() != acu.g.x_prompt_btn_2 || (prompt = this.mPrompt) == null) {
        } else {
            prompt.onAction(1);
        }
    }
