...
public class XQuickSideBarTipsItemView extends XView {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        initDefaultColor();
        this.mTextSize = context.getResources().getDimension(acu.e.x_sidebar_tips_textsize);
        if (attributeSet != null) {
            ...
            this.mBackgroundColor = obtainStyledAttributes.getColor(acu.l.XQuickSideBarView_sidebarBackgroundColor, this.mBackgroundColor);
            obtainStyledAttributes.recycle();
        }
        final XFontScaleHelper create = XFontScaleHelper.create(getResources(), acu.e.x_sidebar_tips_textsize);
        if (create != null && this.mXViewDelegate != null) {
            this.mXViewDelegate.setFontScaleChangeCallback(new XViewDelegate.onFontScaleChangeCallback() { // from class: com.xiaopeng.xui.widget.quicksidebar.-$$Lambda$XQuickSideBarTipsItemView$51XFEO-0GO0VEvoNZW-VFGL4eW4
                ...
                public final void onFontScaleChanged() {
                    XQuickSideBarTipsItemView.lambda$init$0(XQuickSideBarTipsItemView.this, create);
                }
            });
        }
        ...
        this.mTextPaint.setTypeface(Typeface.create(getResources().getString(acu.j.x_font_typeface_number_bold), 0));
        this.mTextPaint.setTextAlign(Paint.Align.CENTER);
    }

    public static /* synthetic */ void lambda$init$0(XQuickSideBarTipsItemView xQuickSideBarTipsItemView, XFontScaleHelper xFontScaleHelper) {
        xQuickSideBarTipsItemView.mTextSize = xFontScaleHelper.getCurrentFontSize(xQuickSideBarTipsItemView.getResources().getDisplayMetrics());
        xQuickSideBarTipsItemView.mTextPaint.setTextSize(xQuickSideBarTipsItemView.mTextSize);
        xQuickSideBarTipsItemView.invalidate();
    }
    ...
    private void initDefaultColor() {
        this.mTextColor = getColor(acu.d.x_side_bar_tips_text_color);
        this.mBackgroundColor = getColor(acu.d.x_side_bar_tips_bg_color);
    }
