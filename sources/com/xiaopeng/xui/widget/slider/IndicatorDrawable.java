...
public class IndicatorDrawable extends Drawable implements Drawable.Callback {
    ...
    public void inflateAttr(Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = theme.obtainStyledAttributes(attributeSet, acu.l.XSlider, 0, i);
        } else {
            obtainStyledAttributes = theme.obtainStyledAttributes(i, acu.l.XSlider);
        }
        if (obtainStyledAttributes.hasValueOrEmpty(acu.l.XSlider_slider_text_tag_bg)) {
            this.mTagBgResId = obtainStyledAttributes.getResourceId(acu.l.XSlider_slider_text_tag_bg, 0);
        }
    ...
    public void refreshUI(Resources resources, Resources.Theme theme) {
        Drawable a = ej.a(resources, this.mTagBgResId, theme);
        XLogUtils.d(TAG, "refreshUI, newBg:" + a + ", oldBg:" + this.mTagBg);
        setTagBg(a);
    }
