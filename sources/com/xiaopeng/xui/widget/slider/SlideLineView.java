...
class SlideLineView extends XView {
    ...
    private void readStyleAttrs(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, acu.l.SlideLineView, 0, i);
        } else {
            obtainStyledAttributes = context.obtainStyledAttributes(i, acu.l.SlideLineView);
        }
        this.bgLineColorUnSelect = obtainStyledAttributes.getColor(acu.l.SlideLineView_slider_line_un_select, this.bgLineColorUnSelect);
        this.bgLineColorSelect = obtainStyledAttributes.getColor(acu.l.SlideLineView_slider_line_select, this.bgLineColorSelect);
