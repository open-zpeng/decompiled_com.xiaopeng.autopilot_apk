...
public class XTimePickerSpinnerDelegate extends XTimePicker.AbstractTimePickerDelegate {
    ...
    public XTimePickerSpinnerDelegate(XTimePicker xTimePicker, Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(attributeSet, acu.l.XTimePicker, i, i2);
        int resourceId = obtainStyledAttributes.getResourceId(acu.l.XTimePicker_tp_xTimePickerLayout, acu.i.x_time_picker_layout);
        ...
        this.mHourSpinner = (XNumberPicker) xTimePicker.findViewById(acu.g.hour);
        this.mHourSpinner.setMinValue(0);
        this.mHourSpinner.setMaxValue(23);
        this.mHourSpinner.setOnLongPressUpdateInterval(100L);
        String[] strArr = new String[24];
        for (int i3 = 0; i3 < strArr.length; i3++) {
            strArr[i3] = context.getResources().getString(acu.j.x_time_picker_hour, Integer.valueOf(i3));
        }
        ...
        this.mMinuteSpinner = (XNumberPicker) this.mDelegator.findViewById(acu.g.minute);
        ...
        for (int i4 = 0; i4 < strArr2.length; i4++) {
            strArr2[i4] = context.getResources().getString(acu.j.x_time_picker_minute, Integer.valueOf(i4));
        }
