...
public class XToggleLayout extends XRelativeLayout implements Checkable {
    ...
    public XToggleLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, acu.k.XToggleLayout_Fill);
    }

    public XToggleLayout(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, acu.k.XToggleLayout_Fill);
    }
    ...
    private void init(Context context, AttributeSet attributeSet, int i, int i2) {
        setClickable(true);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, acu.l.XToggleLayout, i, i2);
        this.mChecked = obtainStyledAttributes.getBoolean(acu.l.XToggleLayout_android_checked, false);
        this.mEnabled = obtainStyledAttributes.getBoolean(acu.l.XToggleLayout_android_enabled, true);
        super.setEnabled(this.mEnabled);
        this.mDisabledAlpha = obtainStyledAttributes.getFloat(acu.l.XToggleLayout_android_disabledAlpha, 0.5f);
        setLoading(obtainStyledAttributes.getBoolean(acu.l.XToggleLayout_loading, false));
        this.mBgId = obtainStyledAttributes.getResourceId(acu.l.XToggleLayout_android_background, 0);
