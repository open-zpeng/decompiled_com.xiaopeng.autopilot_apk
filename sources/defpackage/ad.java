...
public class ad<K, V> implements Iterable<Map.Entry<K, V>> {
    c<K, V> a;
    private c<K, V> b;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ad) {
            ...
            Iterator<Map.Entry<K, V>> it2 = adVar.iterator();
