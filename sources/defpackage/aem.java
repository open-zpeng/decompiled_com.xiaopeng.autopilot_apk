...
public final class aem<T> implements aee<T> {
    static final int a = Integer.getInteger("jctools.spsc.max.lookahead.step", (int) CodedOutputStream.DEFAULT_BUFFER_SIZE).intValue();
