...
public abstract class ahi {
    ...
    public ahi(int i, int i2, int i3, int i4, int i5) {
    ...
    public static ahi a(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        if (i6 != 4) {
            if (i6 == 20) {
                return new ahe(i, i2, i3, i4, i5, i7);
            }
            throw new IllegalArgumentException();
        }
        return new ahg(i, i2, i3, i4, i5, i7);
    }
    ...
    public boolean a(ahj ahjVar) {
        ...
        for (int i = 0; i < ahjVar.c; i++) {
            if (b(ahjVar.b[i], min) != ahjVar.a[i]) {
                return false;
            }
        }
        return true;
