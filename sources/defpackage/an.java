...
class an extends Drawable {
    ...
    public an(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.o = resources.getColor(af.b.cardview_shadow_start_color);
        this.p = resources.getColor(af.b.cardview_shadow_end_color);
        this.c = resources.getDimensionPixelSize(af.c.cardview_compat_inset_shadow);
        b(colorStateList);
        this.e = new Paint(5);
