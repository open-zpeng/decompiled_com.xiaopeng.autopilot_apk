...
public class av<E> implements Cloneable {
    ...
    public av<E> clone() {
        try {
            av<E> avVar = (av) super.clone();
            avVar.c = (int[]) this.c.clone();
            avVar.d = (Object[]) this.d.clone();
            return avVar;
