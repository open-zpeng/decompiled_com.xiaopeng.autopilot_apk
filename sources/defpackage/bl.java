...
public class bl extends bg {
    ...
    public bl(double[] dArr, double[][] dArr2) {
        ...
        while (i6 < length - 1) {
            ...
            if (d < dArr3[i8]) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr5 = this.d;
                    dArr[i] = a(d2, d3, d4, d5, dArr5[i6][i], dArr5[i8][i]);
                    i++;
                }
                return;
            }
        ...
        while (i6 < length - 1) {
            ...
            if (d < dArr2[i8]) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr4 = this.d;
                    fArr[i] = (float) a(d2, d3, d4, d5, dArr4[i6][i], dArr4[i8][i]);
                    i++;
                }
                return;
            }
    ...
    public static bl a(String str) {
        ...
        return a(Arrays.copyOf(dArr, i + 1));
    }

    private static bl a(double[] dArr) {
