    ...
    private static ColorStateList b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == i || ((depth = xmlPullParser.getDepth()) < depth2 && next == 3)) {
                ...
                TypedArray a = a(resources, theme, attributeSet, dz.c.ColorStateListItem);
                int color = a.getColor(dz.c.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (a.hasValue(dz.c.ColorStateListItem_android_alpha)) {
                    f = a.getFloat(dz.c.ColorStateListItem_android_alpha, 1.0f);
                } else if (a.hasValue(dz.c.ColorStateListItem_alpha)) {
                    f = a.getFloat(dz.c.ColorStateListItem_alpha, 1.0f);
                }
                a.recycle();
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != dz.a.alpha) {
                        int i5 = i3 + 1;
                ...
                iArr2 = ei.a(iArr2, i2, a(color, f));
                iArr = (int[][]) ei.a(iArr, i2, trimStateSet);
                i2++;
                i = 1;
            } else {
                i = 1;
