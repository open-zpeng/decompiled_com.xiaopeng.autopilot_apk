...
public class ek {
    ...
    public static ef a(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme, String str, int i, int i2) {
        if (a(xmlPullParser, str)) {
            TypedValue typedValue = new TypedValue();
            typedArray.getValue(i, typedValue);
            if (typedValue.type >= 28 && typedValue.type <= 31) {
                return ef.a(typedValue.data);
            }
            ef a = ef.a(typedArray.getResources(), typedArray.getResourceId(i, 0), theme);
            if (a != null) {
                return a;
            }
        }
    ...
    public static ColorStateList a(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme, String str, int i) {
        if (a(xmlPullParser, str)) {
            ...
            if (typedValue.type == 2) {
                ...
                return ee.a(typedArray.getResources(), typedArray.getResourceId(i, 0), theme);
            }
        }
        return null;
    }
