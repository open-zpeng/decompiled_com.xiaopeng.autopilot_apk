...
public class en {
    ...
    */
    private static void a(java.lang.String r8, int r9, defpackage.en.a r10) {
        /*
            r0 = 0
            r10.b = r0
            r1 = r9
        ...
        L41:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.en.a(java.lang.String, int, en$a):void");
    }
    ...
    public static class b {
        ...
        b(b bVar) {
            this.a = bVar.a;
            float[] fArr = bVar.b;
            this.b = en.a(fArr, 0, fArr.length);
        }
            ...
            while (i3 < fArr2.length) {
                ...
                switch (c2) {
                    ...
                    case 'a':
                        ...
                        float f35 = f12;
                        i2 = i3;
                        a(path, f12, f13, f30, f31, f32, f33, f34, fArr2[i3 + 3] != 0.0f ? true : z, fArr2[i3 + 4] != 0.0f ? true : z);
                        f12 = f35 + fArr2[i26];
                        f13 += fArr2[i27];
                        f9 = f13;
                        f8 = f12;
