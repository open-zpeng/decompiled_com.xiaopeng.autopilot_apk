...
public class hj {
    private static final Interpolator v = new Interpolator() { // from class: hj.1
    ...
    */
    public boolean a(android.view.MotionEvent r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.hj.a(android.view.MotionEvent):boolean");
    }
