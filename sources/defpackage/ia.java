...
public class ia extends Cif implements hz {
    ArrayList<Object> a;
    ...
    private ia(Context context, a aVar, Resources resources) {
        this.f = null;
        this.g = null;
        this.a = null;
        this.b = new Drawable.Callback() { // from class: ia.1
            ...
            public void scheduleDrawable(Drawable drawable, Runnable runnable, long j) {
                ia.this.scheduleSelf(runnable, j);
            }

            @Override // android.graphics.drawable.Drawable.Callback
            public void unscheduleDrawable(Drawable drawable, Runnable runnable) {
                ia.this.unscheduleSelf(runnable);
            }
        };
        this.e = context;
        if (aVar != null) {
    ...
    public static ia a(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ia iaVar = new ia(context);
        iaVar.inflate(resources, xmlPullParser, attributeSet, theme);
        return iaVar;
    }
        ...
        while (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
            if (eventType == 2) {
                ...
                if ("animated-vector".equals(name)) {
                    TypedArray a2 = ek.a(resources, theme, attributeSet, hy.e);
                    int resourceId = a2.getResourceId(0, 0);
                    if (resourceId != 0) {
                        ig a3 = ig.a(resources, resourceId, theme);
                        a3.a(false);
                    ...
                    TypedArray obtainAttributes = resources.obtainAttributes(attributeSet, hy.f);
                    String string = obtainAttributes.getString(0);
                    int resourceId2 = obtainAttributes.getResourceId(1, 0);
                    if (resourceId2 != 0) {
                        Context context = this.e;
                        if (context != null) {
                            a(string, ic.a(context, resourceId2));
                        } else {
    ...
    private static class b extends Drawable.ConstantState {
        ...
        public Drawable newDrawable() {
            ia iaVar = new ia();
            iaVar.c = this.a.newDrawable();
            iaVar.c.setCallback(iaVar.b);
            return iaVar;
        }
        ...
        public Drawable newDrawable(Resources resources) {
            ia iaVar = new ia();
            iaVar.c = this.a.newDrawable(resources);
            iaVar.c.setCallback(iaVar.b);
            return iaVar;
        }
        ...
        public Drawable newDrawable(Resources resources, Resources.Theme theme) {
            ia iaVar = new ia();
            iaVar.c = this.a.newDrawable(resources, theme);
            iaVar.c.setCallback(iaVar.b);
            return iaVar;
        }
    ...
    public static class a extends Drawable.ConstantState {
        ...
        public a(Context context, a aVar, Drawable.Callback callback, Resources resources) {
            if (aVar != null) {
                ...
                ig igVar = aVar.b;
                if (igVar != null) {
                    Drawable.ConstantState constantState = igVar.getConstantState();
                    if (resources != null) {
                        this.b = (ig) constantState.newDrawable(resources);
                    } else {
                        this.b = (ig) constantState.newDrawable();
                    }
                    this.b = (ig) this.b.mutate();
