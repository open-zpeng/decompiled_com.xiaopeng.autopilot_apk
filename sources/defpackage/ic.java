...
public class ic {
    ...
    /* renamed from: ic$a */
    /* loaded from: classes.dex */
    public static class a implements TypeEvaluator<en.b[]> {
        private en.b[] a;
        ...
        /* renamed from: a */
        public en.b[] evaluate(float f, en.b[] bVarArr, en.b[] bVarArr2) {
            if (!en.a(bVarArr, bVarArr2)) {
                throw new IllegalArgumentException("Can't interpolate between two incompatible pathData");
            }
            if (!en.a(this.a, bVarArr)) {
                this.a = en.a(bVarArr);
            }
    ...
    private static void a(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f, XmlPullParser xmlPullParser) {
        long a2 = ek.a(typedArray, xmlPullParser, "duration", 1, 300);
        long a3 = ek.a(typedArray, xmlPullParser, "startOffset", 2, 0);
        int a4 = ek.a(typedArray, xmlPullParser, "valueType", 7, 4);
        if (ek.a(xmlPullParser, "valueFrom") && ek.a(xmlPullParser, "valueTo")) {
            if (a4 == 4) {
                a4 = a(typedArray, 5, 6);
            }
        ...
        valueAnimator.setRepeatCount(ek.a(typedArray, xmlPullParser, "repeatCount", 3, 0));
        valueAnimator.setRepeatMode(ek.a(typedArray, xmlPullParser, "repeatMode", 4, 1));
        if (typedArray2 != null) {
    ...
    private static void a(ValueAnimator valueAnimator, TypedArray typedArray, int i, float f, XmlPullParser xmlPullParser) {
        ...
        String a2 = ek.a(typedArray, xmlPullParser, "pathData", 1);
        if (a2 != null) {
            String a3 = ek.a(typedArray, xmlPullParser, "propertyXName", 2);
            String a4 = ek.a(typedArray, xmlPullParser, "propertyYName", 3);
            if (i != 2) {
            }
            if (a3 == null && a4 == null) {
                throw new InflateException(typedArray.getPositionDescription() + " propertyXName or propertyYName is needed for PathData");
            }
            a(en.a(a2), objectAnimator, f * 0.5f, a3, a4);
            return;
        }
        objectAnimator.setPropertyName(ek.a(typedArray, xmlPullParser, "propertyName", 0));
    }
    ...
    */
    private static android.animation.Animator a(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ic.a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.animation.AnimatorSet, int, float):android.animation.Animator");
    }
        ...
        while (true) {
            ...
            if (eventType == 3 || eventType == 1) {
                ...
                if (xmlPullParser.getName().equals("propertyValuesHolder")) {
                    TypedArray a2 = ek.a(resources, theme, attributeSet, hy.i);
                    String a3 = ek.a(a2, xmlPullParser, "propertyName", 3);
                    int a4 = ek.a(a2, xmlPullParser, "valueType", 2, 4);
    ...
    private static int a(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray a2 = ek.a(resources, theme, attributeSet, hy.j);
        int i = 0;
        TypedValue b = ek.b(a2, xmlPullParser, "value", 0);
        if ((b != null) && a(b.type)) {
            i = 3;
        }
        a2.recycle();
    ...
    private static PropertyValuesHolder a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, String str, int i) throws XmlPullParserException, IOException {
        ...
        if (arrayList != null && (size = arrayList.size()) > 0) {
            ...
            if (i2 == 3) {
                propertyValuesHolder.setEvaluator(id.a());
            }
        }
        return propertyValuesHolder;
    }
    ...
    private static Keyframe a(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        Keyframe ofInt;
        TypedArray a2 = ek.a(resources, theme, attributeSet, hy.j);
        float a3 = ek.a(a2, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue b = ek.b(a2, xmlPullParser, "value", 0);
        boolean z = b != null;
        if (i == 4) {
            i = (z && a(b.type)) ? 3 : 0;
        ...
        if (z) {
            if (i != 3) {
                switch (i) {
                    case 0:
                        ofInt = Keyframe.ofFloat(a3, ek.a(a2, xmlPullParser, "value", 0, 0.0f));
                        break;
                    case 1:
                        break;
                    default:
            ...
            ofInt = Keyframe.ofInt(a3, ek.a(a2, xmlPullParser, "value", 0, 0));
        } else if (i == 0) {
            ofInt = Keyframe.ofFloat(a3);
        } else {
            ofInt = Keyframe.ofInt(a3);
        }
        int c = ek.c(a2, xmlPullParser, "interpolator", 1, 0);
        if (c > 0) {
            ofInt.setInterpolator(ib.a(context, c));
        }
        a2.recycle();
        return ofInt;
    }
    ...
    private static ValueAnimator a(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
        TypedArray a2 = ek.a(resources, theme, attributeSet, hy.g);
        TypedArray a3 = ek.a(resources, theme, attributeSet, hy.k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        a(valueAnimator, a2, a3, f, xmlPullParser);
        int c = ek.c(a2, xmlPullParser, "interpolator", 0, 0);
        if (c > 0) {
            valueAnimator.setInterpolator(ib.a(context, c));
        }
        a2.recycle();
        if (a3 != null) {
            a3.recycle();
