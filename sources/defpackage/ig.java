...
public class ig extends Cif {
    ...
    public static ig a(Resources resources, int i, Resources.Theme theme) {
        int next;
        if (Build.VERSION.SDK_INT >= 24) {
            ig igVar = new ig();
            igVar.c = ej.a(resources, i, theme);
            igVar.h = new h(igVar.c.getConstantState());
            return igVar;
        }
        try {
    ...
    public static ig a(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ig igVar = new ig();
        igVar.inflate(resources, xmlPullParser, attributeSet, theme);
        return igVar;
    }
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        g gVar = this.b;
        gVar.b = new f();
        TypedArray a2 = ek.a(resources, theme, attributeSet, hy.a);
    ...
    private void a(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme) throws XmlPullParserException {
        g gVar = this.b;
        f fVar = gVar.b;
        gVar.d = a(ek.a(typedArray, xmlPullParser, "tintMode", 6, -1), PorterDuff.Mode.SRC_IN);
        ColorStateList a2 = ek.a(typedArray, xmlPullParser, theme, "tint", 1);
        if (a2 != null) {
            gVar.c = a2;
        }
        gVar.e = ek.a(typedArray, xmlPullParser, "autoMirrored", 5, gVar.e);
        fVar.f = ek.a(typedArray, xmlPullParser, "viewportWidth", 7, fVar.f);
        fVar.g = ek.a(typedArray, xmlPullParser, "viewportHeight", 8, fVar.g);
        if (fVar.f <= 0.0f) {
            ...
            if (fVar.d <= 0.0f) {
                ...
                fVar.setAlpha(ek.a(typedArray, xmlPullParser, ThemeManager.AttributeSet.ALPHA, 4, fVar.getAlpha()));
    ...
    public static class h extends Drawable.ConstantState {
        ...
        public Drawable newDrawable() {
            ig igVar = new ig();
            igVar.c = (VectorDrawable) this.a.newDrawable();
            return igVar;
        }
        ...
        public Drawable newDrawable(Resources resources) {
            ig igVar = new ig();
            igVar.c = (VectorDrawable) this.a.newDrawable(resources);
            return igVar;
        }
        ...
        public Drawable newDrawable(Resources resources, Resources.Theme theme) {
            ig igVar = new ig();
            igVar.c = (VectorDrawable) this.a.newDrawable(resources, theme);
            return igVar;
        }
        ...
        private void a(c cVar, e eVar, Canvas canvas, int i, int i2, ColorFilter colorFilter) {
            ...
            if (bVar.c.e()) {
                ...
                if (efVar.c()) {
                    ...
                    paint.setAlpha(255);
                    paint.setColor(ig.a(efVar.b(), bVar.e));
                }
            ...
            if (bVar.a.e()) {
                ...
                if (efVar2.c()) {
                    ...
                    paint2.setAlpha(255);
                    paint2.setColor(ig.a(efVar2.b(), bVar.d));
                }
    ...
    public static class c extends d {
        ...
        public c(c cVar, ao<String, Object> aoVar) {
            super();
            e aVar;
            this.a = new Matrix();
        ...
        public void a(Resources resources, AttributeSet attributeSet, Resources.Theme theme, XmlPullParser xmlPullParser) {
            TypedArray a = ek.a(resources, theme, attributeSet, hy.b);
            a(a, xmlPullParser);
            a.recycle();
        }
        ...
        private void a(TypedArray typedArray, XmlPullParser xmlPullParser) {
            this.l = null;
            this.c = ek.a(typedArray, xmlPullParser, "rotation", 5, this.c);
            this.f = typedArray.getFloat(1, this.f);
            this.g = typedArray.getFloat(2, this.g);
            this.h = ek.a(typedArray, xmlPullParser, "scaleX", 3, this.h);
            this.i = ek.a(typedArray, xmlPullParser, "scaleY", 4, this.i);
            this.j = ek.a(typedArray, xmlPullParser, "translateX", 6, this.j);
            this.k = ek.a(typedArray, xmlPullParser, "translateY", 7, this.k);
            String string = typedArray.getString(0);
            if (string != null) {
                this.m = string;
            }
    ...
    public static abstract class e extends d {
        ...
        public en.b[] getPathData() {
            return this.l;
        }

        public void setPathData(en.b[] bVarArr) {
            if (!en.a(this.l, bVarArr)) {
                this.l = en.a(bVarArr);
            } else {
                en.b(this.l, bVarArr);
            }
    ...
    public static class a extends e {
        ...
        public void a(Resources resources, AttributeSet attributeSet, Resources.Theme theme, XmlPullParser xmlPullParser) {
            if (ek.a(xmlPullParser, "pathData")) {
                TypedArray a = ek.a(resources, theme, attributeSet, hy.d);
                a(a, xmlPullParser);
                a.recycle();
            }
        }
        ...
        private void a(TypedArray typedArray, XmlPullParser xmlPullParser) {
            ...
            this.n = ek.a(typedArray, xmlPullParser, "fillType", 2, 0);
        }
    }
    ...
    public static class b extends e {
        ...
        public void a(Resources resources, AttributeSet attributeSet, Resources.Theme theme, XmlPullParser xmlPullParser) {
            TypedArray a = ek.a(resources, theme, attributeSet, hy.c);
        ...
        private void a(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme) {
            ...
            if (ek.a(xmlPullParser, "pathData")) {
                ...
                this.c = ek.a(typedArray, xmlPullParser, theme, "fillColor", 1, 0);
                this.e = ek.a(typedArray, xmlPullParser, "fillAlpha", 12, this.e);
                this.i = a(ek.a(typedArray, xmlPullParser, "strokeLineCap", 8, -1), this.i);
                this.j = a(ek.a(typedArray, xmlPullParser, "strokeLineJoin", 9, -1), this.j);
                this.k = ek.a(typedArray, xmlPullParser, "strokeMiterLimit", 10, this.k);
                this.a = ek.a(typedArray, xmlPullParser, theme, "strokeColor", 3, 0);
                this.d = ek.a(typedArray, xmlPullParser, "strokeAlpha", 11, this.d);
                this.b = ek.a(typedArray, xmlPullParser, "strokeWidth", 4, this.b);
                this.g = ek.a(typedArray, xmlPullParser, "trimPathEnd", 6, this.g);
                this.h = ek.a(typedArray, xmlPullParser, "trimPathOffset", 7, this.h);
                this.f = ek.a(typedArray, xmlPullParser, "trimPathStart", 5, this.f);
                this.n = ek.a(typedArray, xmlPullParser, "fillType", 13, this.n);
            }
        }
