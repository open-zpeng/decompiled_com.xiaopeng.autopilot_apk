...
public class l extends Drawable implements Drawable.Callback {
    ...
    public boolean a(int i) {
        ...
        if (this.j != 0 || this.k != 0) {
            ...
            if (runnable == null) {
                this.i = new Runnable() { // from class: l.1
    ...
    */
    void a(boolean r14) {
        ...
        L74:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.l.a(boolean):void");
    }
    ...
    public static abstract class c extends Drawable.ConstantState {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public c(c cVar, l lVar, Resources resources) {
            ...
            this.d = resources2;
            this.e = l.a(resources, cVar != null ? cVar.e : 0);
            if (cVar != null) {
                this.f = cVar.f;
                this.g = cVar.g;
                this.x = true;
