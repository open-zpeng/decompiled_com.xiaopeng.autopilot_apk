...
public class nu extends nw implements kh {
    protected final kh a;

    /* JADX INFO: Access modifiers changed from: protected */
    public nu(nx nxVar, kh khVar) {
        super(nxVar);
        this.a = khVar;
    }
    ...
    public void glTexImage3D(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, Buffer buffer) {
        this.b++;
        this.a.glTexImage3D(i, i2, i3, i4, i5, i6, i7, i8, i9, buffer);
        g();
    }
    ...
    public void glDrawBuffers(int i, IntBuffer intBuffer) {
        this.d++;
        this.b++;
        this.a.glDrawBuffers(i, intBuffer);
        g();
    }
    ...
    public void glDeleteVertexArrays(int i, IntBuffer intBuffer) {
        this.b++;
        this.a.glDeleteVertexArrays(i, intBuffer);
        g();
    }
    ...
    public void glGenVertexArrays(int i, IntBuffer intBuffer) {
        this.b++;
        this.a.glGenVertexArrays(i, intBuffer);
        g();
    }
}
