...
public class q {
    ...
    public boolean d() {
        return this.a.getResources().getBoolean(i.b.abc_action_bar_embed_tabs);
    }

    public int e() {
        TypedArray obtainStyledAttributes = this.a.obtainStyledAttributes(null, i.j.ActionBar, i.a.actionBarStyle, 0);
    ...
    public int g() {
        return this.a.getResources().getDimensionPixelSize(i.d.abc_action_bar_stacked_tab_max_width);
    }
}
